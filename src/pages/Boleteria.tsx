        ...
        <ScrollReveal>
          ...
          >
            ...
            <div className="relative z-10 p-8 text-center">
              ...
              <h3 className="font-display font-bold text-2xl uppercase text-white mb-3 m-0">
                Consigue tus boletos
              </h3>
              <p className="text-white/50 text-sm mb-6 m-0 max-w-xs mx-auto">
                No te pierdas ni un solo juego. Asegura tu asiento para vivir la
                emocion del voleibol de los Cafeteros de Yauco en vivo.
              </p>
              <a
                href="https://cafeterosdeyaucovollyball.printcotickets.com/browse"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-8 py-3.5 bg-gold text-black font-display font-bold text-sm uppercase tracking-wider rounded-full no-underline transition-transform duration-200 hover:scale-105"
              >
                Comprar Boletos
              </a>
            </div>
